                                                ...
                                                <div id="container2">
                                                    <div class="data">
                                                        ...
                                                        <table class="table table-bordered dataTable" id="DataTables_Table_0">
                                                          ...
                                                          <td style="text-align:center">Short Color</td>
                                                          <td style="text-align:center">Socks Color</td>
                                                          <td style="text-align:center">Student Limit</td>
