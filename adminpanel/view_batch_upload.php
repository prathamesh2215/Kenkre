                                                ...
                                                <div id="container2">
                                                    <div class="data">
                                                        ...
                                                        <table class="table table-bordered dataTable" id="DataTables_Table_0">
                                                          ...
                                                          <td style="text-align:center">Reg. Strat Date</td>
                                                          <td style="text-align:center">Reg. End Date</td>
                                                          <td style="text-align:center">Batch Start Date</td>
                                                          <td style="text-align:center">Batch End Date</td>
                                                          ...
                                                          <td style="text-align:center">Timing</td>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls" style="float:left;">
                                                                	<input type="hidden" name="batch_file" id="batch_file" value="1"/>
