                            ...
                            <div class="span12">
                                <div class="box box-color box-bordered">
                                    ...
                                    <div style="padding:10px 15px 10px 15px !important">
                                        ...
                                        <input type="text" class="input-medium" id = "srch" name="srch" placeholder="Search by City Name, Country Id,State Id ..."  style="float:right;margin-right:10px;margin-top:10px;width:300px" >
                                    </div>
                                    <div id="req_resp"></div>
