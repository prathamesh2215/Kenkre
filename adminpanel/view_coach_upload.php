                                                ...
                                                <div id="container2">
                                                    <div class="data">
                                                        ...
                                                        <table class="table table-bordered dataTable" id="DataTables_Table_0">
                                                          ...
                                                          <td style="text-align:center">Contact Strat Date</td>
                                                          <td style="text-align:center">Contact End Date</td>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls" style="float:left;">
                                                                	<input type="hidden" name="coach_file" id="coach_file" value="1"/>
