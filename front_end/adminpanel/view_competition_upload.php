...
<div class="box box-color box-bordered">
                                    <div class="box-title">
                                        <h3>
                                            ...
                                            Excel Bulk Upload For Competition
                                        </h3>
                                                ...
                                                <div id="container2">
                                                    <div class="data">
                                                        ...
                                                        <table class="table table-bordered dataTable" id="DataTables_Table_0">
                                                          ...
                                                          <tr>
                                                          <td style="text-align:center">Competition Name</td>
                                                          <td style="text-align:center">Competition Start Date</td>
                                                          <td style="text-align:center">Competition End Date</td>
                                                          <td style="text-align:center">Place</td>
                                                          <td style="text-align:center">Team Limit</td>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls" style="float:left;">
                                                                	<input type="hidden" name="competition_file" id="coach_file" value="1"/>
