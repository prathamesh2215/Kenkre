    ...
    <div class="container-fluid" id="content">
            <div id="main" style="margin-left:0px !important">
                <div class="container-fluid" id="div_view_area">                
					<?php 
                    /* this function used to add navigation menu to the page*/ 
                    breadcrumbs($home_url,$home_name,'View Fixtures',$filename,$feature_name); 
                    /* this function used to add navigation menu to the page*/ 
                    ?>          
                        <div class="row-fluid">
                            <div class="span12">
                                <div class="box box-color box-bordered">
									...
									{
									?>
									  <button type="button" class="btn-info" onClick="addMoreFixture('','add')" ><i class="icon-plus"></i>&nbspAdd Fixtures</button>
									<?php		
									}
									?>                                       
		...
		function loadData()
		{
			...
			{
				var sendInfo = {"ft_date":ft_date,"ft_time":ft_time,"row_limit":row_limit, "search_text":search_text, "load_competition":1, "page":page};
		...
		function addMoreFixture(fixture_id,req_type)
		{
			...
			var sendInfo = {"fixture_id":fixture_id,"req_type":req_type,"load_fixture_parts":1};
