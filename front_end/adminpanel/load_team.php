...
if((isset($_POST['insert_team'])) == "1" && isset($_POST['insert_team']))
{
	...
	$data['pool']            = mysqli_real_escape_string($db_con,$_POST['team_pool']);
	$data['team_type']       = mysqli_real_escape_string($db_con,$_POST['ddl_team_type']);
...
if((isset($obj->load_team_parts)) == "1" && isset($obj->load_team_parts))
{
	...
	if($req_type != "")
	{
		...
		if($req_type !='view')
		{
			...
			// =======================================================================================================
			// START : Team Pool [Dn By Prathamesh On 27-11-2017]
			// =======================================================================================================
			...
			$data .= '<div class="control-group">';
				...
				$data .= '<div class="controls">';
					$data .= '<input type="text" id="team_pool" name="team_pool" class="input-large" placeholder="Team Pool" value="'.@$row_student_data['pool'].'" />';
				$data .= '</div>';
			$data .= '</div>'; // Pool
			...
			$data .= '<div class="control-group">';
				$data .= '<label for="tasktitel" class="control-label">Pool<sup class="validfield"><span style="color:#F00;font-size:20px;">*</span></sup></label>';
				$data .= '<div class="controls">';
					$data .= '<select id="ddl_team_type" name="ddl_team_type" class="select2-me input-large">';
						$data .= '<option value="">Select Type</option>';
						$data .= '<option value="inner">Inside Kenkre</option>';
						$data .= '<option value="outter">Outside Kenkre</option>';
					$data .= '</select>';
				$data .= '</div>';
			$data .= '</div>'; // Team Type [Out Of Kenkre OR Inside Kenkre]			

			// =======================================================================================================
			// END : Team Pool [Dn By Prathamesh On 27-11-2017]
			// =======================================================================================================
