...
if ($_SERVER['HTTP_HOST'] == "localhost" || preg_match("/^192\.168\.0.\d+$/",$_SERVER['HTTP_HOST']) || preg_match("/^praful$/",$_SERVER['HTTP_HOST'])) 
{
	...
	$dbuser = "root";
	$dbpass = "";
	$BaseFolder = "http://localhost/kenkre/kfcpanel/";	
}
else
{
	$dbname = "db_kfc";
	...
	$BaseFolder = "http://www.kenkre.com/kfcpanel";	
	include("../PHPMailer/class.phpmailer.php");}
...
function headerdata($feature_name)
{
	?>
	    ...
	    <link rel="shortcut icon" href="img/kenkre-logo-sample-fav-icon.png">
		<!-- Bootstrap -->
	...
	?>
    	<div id="navigation">
			<div class="container-fluid" >
				<a href="view_dashboard.php?pag=Dashboard" id="brand">Kenkre<!--<img src="img/kenkre-logo-sample.png" style="height:40px;">--></a>
				<!-- main menu -->
            	<?php 
